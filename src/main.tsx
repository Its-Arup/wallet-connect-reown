...
import { arbitrum, mainnet, AppKitNetwork, bscTestnet, sepolia } from '@reown/appkit/networks'
...
// 3. Set the networks
export const chains: [AppKitNetwork, ...AppKitNetwork[]] = [mainnet, arbitrum, bscTestnet, sepolia];
